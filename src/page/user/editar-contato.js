...
return (       
    ...
    <div>
         ...
         <FormEdit id={this.state.data.id} nome={this.state.data.nome} email={this.state.data.email}></FormEdit>
        <br></br><br></br>
...

                    {
                        ...
                        return (
                                ...
                                <tr key={item.id}> 
                                    ...
                                    <td> {item.nome} </td>
                                    <td> {item.email} </td>
                                    <td><button onClick={this.getDadosParaEditar.bind(this,item)}>EDIT</button></td>
                                    <td><button onClick={this.deleteContato.bind(this,item.id)}>DELETE</button></td> 
